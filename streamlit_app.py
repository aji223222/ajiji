...
data = {
    'タイトル': [
        ...
        'Persona 3 Reload', 'Unicorn Overlord', 'Elden Ring: Shadow of the Erdtree',
        'Dragon’s Dogma 2', 'Rise of the Ronin', 'Shadow of the Colossus (Remake)'
    ],
    'ジャンル': [
        ...
        'アクション', '格闘', '格闘',
        'RPG', 'シミュレーションRPG', 'アクションRPG',
        'アクションRPG', 'アクションRPG', 'アクションアドベンチャー'
    ],
    '評価(Metacritic)': [
